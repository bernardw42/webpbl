        ...
        <>
            <div className="bg-[white] w-full min-h-[1000px] flex flex-col justify-center items-center pt-[230px] pb-[200px]">
                <div className="max-w-7xl flex flex-col px-8 justify-center">
                    <div ref={textRef}>
                      <h1 className={`text-[#033C5A] font-bold md:text-5xl sm:text-4xl lg:text-6xl text-4xl mb-[70px] max-lg:text-center text-left duration-[1500ms] opacity-0 ${textInView ? 'opacity-100' : ''}`}>Artikel</h1>
                    </div>
                ...
                <h2 className='text-center font-semibold text-[25px] mb-[20px] p-8 text-[#2E364D]'>Bergabunglah dengan newsletter untuk mendapatkan update terbaru</h2>
