                ...
                <div className='flex flex-wrap gap-y-[50px] gap-x-[100px] px-6 justify-start'>
                    ...
                    <div className="flex flex-col justify-between max-w-[500px] gap-y-[50px] px-2 ">
                        <ul className="flex flex-wrap text-[#033C5A] max-md:flex-col">
                            <li>
                                <Link href={generatePath('aboutus', pathname === '/id' ? 'id' : 'en')} className="font-medium text-[17px] hover:text-[#2c365a] pr-5 py-3 max-md:pr-[0px] flex items-center transition duration-150 ease-in-out">{navbarText[pathname === '/id' ? 'id' : 'en'].about}</Link>
                            </li>
                            <li>
                                <Link href={generatePath('services', pathname === '/id' ? 'id' : 'en')} className="font-medium text-[17px] hover:text-[#2c365a] px-5 py-3 max-md:px-[0px] flex items-center transition duration-150 ease-in-out">{navbarText[pathname === '/id' ? 'id' : 'en'].services}</Link>
                            </li>
                            <li>
                                <Link href={generatePath('article', pathname === '/id' ? 'id' : 'en')} className="font-medium text-[17px] hover:text-[#2c365a] px-5 py-3 max-md:px-[0px] flex items-center transition duration-150 ease-in-out">{navbarText[pathname === '/id' ? 'id' : 'en'].article}</Link>
                            </li>
                            <li>
                                <Link href={generatePath('contactus', pathname === '/id' ? 'id' : 'en')} className="font-medium text-[17px] hover:text-[#2c365a] pl-5 py-3 max-md:pl-[0px] flex items-center transition duration-150 ease-in-out">{navbarText[pathname === '/id' ? 'id' : 'en'].contact}</Link>
                            </li>
                        </ul>
                        <div className="flex flex-col text-[#033C5A]">
