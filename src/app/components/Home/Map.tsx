                    ...
                    {state => (
                        <div className="flex flex-col gap-y-[40px]">
                            <div className={`flex items-center transform gap-x-[20px] transition-all duration-[1500ms] ${state === 'entered' ? 'translate-x-0 opacity-100' : 'translate-x-[150px] opacity-0'}`}>
                                ...
                                <h1 className="text-blue-700 font-semibold text-xl">One Stop Solution Logistics Service <br></br> (Supply Chain Management)</h1>
                            </div>
                            <div className={`flex items-center transform gap-x-[20px] transition-all duration-[1500ms] ${state === 'entered' ? 'translate-x-0 opacity-100' : 'translate-x-[150px] opacity-0'}`}>
                                <Image src={img3} alt="map" width={70} height={70} />
                                <h1 className="text-blue-700 font-semibold text-xl">Warehouse Management</h1>
                            </div>
                            <div className={`flex items-center transform gap-x-[20px] transition-all duration-[1500ms] ${state === 'entered' ? 'translate-x-0 opacity-100' : 'translate-x-[150px] opacity-0'}`}>
                                <Image src={img6} alt="map" width={70} height={70} />
                                <h1 className="text-blue-700 font-semibold text-xl">Freight Forwarding Service</h1>
                            </div>
                            <div className={`flex items-center transform gap-x-[20px] transition-all duration-[1500ms] ${state === 'entered' ? 'translate-x-0 opacity-100' : 'translate-x-[150px] opacity-0'}`}>
                                <Image src={img7} alt="map" width={70} height={70} />
                                <h1 className="text-blue-700 font-semibold text-xl">Experiencing Manpower</h1>
                            </div>
                        </div>
                    )}
                </Transition>
