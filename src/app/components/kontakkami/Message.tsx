    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <div className="bg-white w-full flex flex-col justify-center items-center pb-[150px] pt-[230px]" ref={textRef}>
                <h1 className={`text-center max-w-7xl text-[#033C5A] font-bold md:text-5xl sm:text-4xl lg:text-6xl text-4xl md:leading-[80px] lg:leading-[100px] max-md:mb-[20px] px-8 transition-all duration-[1500ms] leading-[60px] opacity-0 ${textInView ? 'opacity-100' : ''}`}>Hubungi Kami</h1>
                <h1 className={`text-center max-w-7xl text-[#033C5A] font-semibold text-xl px-8 transition-all duration-[1500ms] leading-[60px] opacity-0 ${textInView ? 'opacity-100' : ''}`}>Kami ingin mengenalmu dan dengan senang hati akan menjawab pertanyaanmu!</h1>
            </div>
            ...
            <div className='bg-white flex justify-center w-full min-h-[1020px] pb-[200px] pt-[200px] max-lg:pb-[150px] max-lg:pt-[150px]' ref={ref2}>
                <div className={`flex justify-start flex-wrap gap-x-[70px] duration-[1500ms] ${secinView ? 'opacity-100' : 'opacity-0'}`}>
                <div className='flex flex-col px-8 mb-[50px]'>
                    <h1 className='text-[35px] text-[#2E364D] font-bold mb-[30px]'>LOKASI KAMI</h1>
                    <Image src={map} alt="map" className="w-[600px] h-auto"></Image>
                </div>
                <div className='flex flex-col max-w-[600px] gap-y-[50px] px-8'>
                    <div className='flex flex-col gap-y-[30px]'>
                        <h1 className='text-[35px] text-[#2E364D] font-bold'>KANTOR PUSAT</h1>
                    ...
                    <div className='flex flex-col gap-y-[30px]'>
                        <h1 className='text-[35px] text-[#2E364D] font-bold'>CABANG</h1>
                        <div className='flex text-[#033C5A] font-medium text-[18px] items-center gap-x-[20px]'>
